	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			if(properties.getProperty("IS_APPLICATION_IN_SANDBOX").toString().equals("true")) {
				...
				ac.setCreateBillingAgreementTokenUrl(properties.getProperty("CREATE_BA_TOKEN_URL").toString());
				ac.setCreateBillingAgreementUrl(properties.getProperty("CREATE_BA_URL").toString());
